...
module.exports = function(app) {
  app.factory('MmmService', function() {
    return function() {
      return {
        mean: function(array) { //average of all nums
        ...
        median: function(array) { //in sorted ascending or descending, the middle most integer
          var length;
          var x;
          var y;
          var midNum;
        ...
        mode: function(array) { //the num that is repeated the most
